            ...
            <div className="grid md:grid-cols-3 gap-8 mb-24">
                <div className="p-8 border border-border rounded-xl bg-card">
                    ...
                    <p className="text-sm text-muted-foreground mt-2">
                        When clients have a verified Proof Packet, they pay faster.
                    </p>
                </div>
                <div className="p-8 border border-border rounded-xl bg-card">
                    ...
                    <p className="text-sm text-muted-foreground mt-2">
                        Eliminate "did you really work on this?" conversations forever.
                    </p>
                </div>
                <div className="p-8 border border-border rounded-xl bg-card">
                    ...
                    <p className="text-sm text-muted-foreground mt-2">
                        Automated collection of evidence means PMs can focus on delivery.
                    </p>
                </div>
            </div>
                ...
                <div className="flex-1 space-y-4">
                    ...
                    <ul className="space-y-3">
                        <li className="flex items-center gap-2">
                            <span className="bg-primary/20 text-primary p-1 rounded-full text-xs">
                                ✓
                            </span>
                            <span>
                        ...
                        <li className="flex items-center gap-2">
                            ...
                            <span>
                                <strong>SOC2 Ready:</strong> Built on compliant infrastructure
                                (Render/Supabase).
                            </span>
                        </li>
                        <li className="flex items-center gap-2">
                            ...
                            <span>
                                <strong>Tamper-Evident:</strong> All events are hash-chained for
                                auditability.
                            </span>
                        </li>
                    </ul>
