    ...
    return (
        <div className="py-24 px-6 max-w-4xl mx-auto">
            ...
            <div className="prose prose-invert max-w-none text-muted-foreground">
                ...
                <p>
                    ShipDocket shall process Personal Data only on behalf of and in accordance with
                    your instructions. We act as a Processor for the metadata you provide.
                </p>
                ...
                <h3 className="text-foreground mt-8 mb-4 font-bold text-xl">4. Sub-processors</h3>
                <p>
                    You authorize us to engage sub-processors (e.g., Supabase, Render) to provide
                    the Service. We remain liable for their acts and omissions.
                </p>
            </div>
        </div>
    );
