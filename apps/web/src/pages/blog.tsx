                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="border border-border rounded-xl bg-card overflow-hidden hover:border-primary transition-colors cursor-pointer group">
                        ...
                        <div className="p-6">
                            ...
                            <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors">
                                Deep Proof: Verify Build Artifacts
                            </h3>
                            <p className="text-sm text-muted-foreground">
                                Introducing a new way to verify not just the code, but the binary
                                itself.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="border border-border rounded-xl bg-card overflow-hidden hover:border-primary transition-colors cursor-pointer group">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Connect your Linear workspace to ShipDocket for seamless status
                                tracking.
                            </p>
                        </div>
                    </div>
