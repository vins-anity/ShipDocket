            ...
            <div className="flex items-center justify-between">
                <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight">{proof.task.key}</h1>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <Card className="bg-card/50 backdrop-blur-sm border-white/5">
                        <CardHeader>
                            ...
                            <CardDescription>Client-friendly summary powered by AI</CardDescription>
                        </CardHeader>
                        <CardContent>
                            {proof.aiSummary ? (
                                <div className="space-y-4">
                        ...
                        <CardContent className="space-y-4 text-sm">
                            ...
                            {proof.hashChainRoot && (
                                <div className="pt-3 border-t border-white/5 space-y-2">
                                    ...
                                    <div className="bg-black/20 p-2 rounded border border-white/5 font-mono text-[10px] break-all text-muted-foreground">
                                        {proof.hashChainRoot}
                                    </div>
                                </div>
                            )}
